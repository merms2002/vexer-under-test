  ...
  return (
    <div className="space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link 
              ...
              className="text-sm text-white/50 hover:text-[#FF4500] transition-colors"
            >
              Forget password?
            </Link>
          </div>
      ...
      <p className="text-center text-white/50 text-sm">
        ...
        <Link href="/auth/sign-up" className="text-white hover:text-[#FF4500] transition-colors font-medium">
          Sign up
        </Link>
      </p>
    </div>
