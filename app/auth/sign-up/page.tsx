    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/[0.02] backdrop-blur-2xl border border-white/10 rounded-2xl p-6 space-y-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="email" className="text-white/50 text-sm">Email Id</Label>
            <Input
              id="email"
              type="email"
              value={email}
          ...
          <div className="space-y-2">
            <Label htmlFor="password" className="text-white/50 text-sm">Password</Label>
            <Input
              id="password"
              type="password"
              value={password}
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-[#050505] px-4 text-white/30">or</span>
          </div>
        </div>
      ...
      <p className="text-center text-white/50 text-sm">
        ...
        <Link href="/auth/login" className="text-white hover:text-[#FF4500] transition-colors font-medium">
          Login
        </Link>
      </p>
    </div>
