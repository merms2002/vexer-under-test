...
const plans = [
  {
    name: "Solo",
    description: "Personal study with unlimited games and coaching notes.",
    price: { monthly: 0, yearly: 0 },
    features: ["Unlimited PGN uploads", "Daily email insights", "Community opening library", "1 saved workspace"],
    cta: "Start for free",
    highlighted: false,
  },
  {
    name: "Club",
    description: "Share dashboards with your teammates, students, or club mates.",
    price: { monthly: 29, yearly: 24 },
    features: [
      "5 seats with shared analysis",
      "Private opening libraries",
      "Coach notes & exports",
      "Live Signal overlays",
      "Priority support",
    ],
    cta: "Try Club edition",
    highlighted: true,
  },
  {
    name: "Enterprise",
    description: "Custom analyst tooling for academies, broadcasters, and federations.",
    ...
    <section id="pricing" className="py-24 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            Transparent pricing built for chess
          </h2>
          <p className="text-[#c9d0ff]/80 max-w-2xl mx-auto mb-8">
            Solo players stay free forever. Club plans unlock shared analysis, live signals, and coach-ready workflows.
          </p>
            ...
            >
                ...
                <div className="flex items-baseline gap-1">
                  {plan.price[billingCycle] === 0 ? (
                    ...
                    <>
                      ...
                      <span className="text-xs text-zinc-400 mt-2">/month</span>
                    </>
                  )}
                </div>
                {billingCycle === "yearly" && plan.price.yearly > 0 && (
                  <p className="text-xs text-[#9aa0c1] mt-1">Billed annually (${plan.price.yearly * 12}/year)</p>
                )}
              </div>
              ...
              <Button
                className={`w-full rounded-full ${
                  plan.highlighted
                    ? "shimmer-btn bg-white text-[#0b0703] hover:bg-zinc-100"
